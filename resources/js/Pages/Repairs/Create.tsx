...
import { Wrench, UserRound, X } from 'lucide-react';
...
export default function RepairsCreate({ customers }: Props) {
        ...
        <AuthenticatedLayout>
            ...
            <div className="mx-auto max-w-xl space-y-6 p-6">
                <div className="flex items-center justify-between">
                    ...
                    <Button variant="outline" onClick={() => router.get(route('repairs.index'))}>
                        Back
                    </Button>
                </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            {/* Walk-in name override (shown when no customer selected) */}
                            {!data.customer_id && (
                                <div className="space-y-1">
                                    <Label htmlFor="customer_name">Customer Name <span className="text-muted-foreground text-xs">(for walk-in)</span></Label>
                                    <Input
                                        id="customer_name"
                            ...
                            <div className="space-y-1">
                                ...
                                <Textarea
                                    ...
                                    placeholder="Describe the issue with the WiFi vendo unit…"
                                    rows={4}
                                    required
                                />
                            ...
                            <div className="flex justify-end gap-2 pt-2">
                                <Button type="button" variant="outline" onClick={() => router.get(route('repairs.index'))}>
                                    Cancel
                                </Button>
