...
export default function EmployeeCreateModal({ open, onClose, users }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('employees.store'), { onSuccess: () => { reset(); onClose(); } });
    };
        ...
        <Dialog open={open} onOpenChange={handleOpenChange}>
            <DialogContent className="max-w-2xl max-h-[90vh] flex flex-col">
                ...
                <div className="overflow-y-auto flex-1 pr-1">
                        <form id="employee-create-form" onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-4">
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {errors.hired_at && <p className="text-sm text-destructive">{errors.hired_at}</p>}
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    <Label>Address</Label>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    <div className="space-y-2">
                                        ...
                                        <Input value={data.sss_number} onChange={(e) => setData('sss_number', e.target.value)} />
                                    </div>
                                    <div className="space-y-2">
                                        <Label>PhilHealth Number</Label>
                                        <Input value={data.philhealth_number} onChange={(e) => setData('philhealth_number', e.target.value)} />
                                    </div>
                                    <div className="space-y-2">
                                        <Label>Pag-IBIG Number</Label>
                                        <Input value={data.pagibig_number} onChange={(e) => setData('pagibig_number', e.target.value)} />
                                    </div>
                                    <div className="space-y-2">
                                        <Label>TIN</Label>
                                        <Input value={data.tin} onChange={(e) => setData('tin', e.target.value)} />
                                    </div>
                                </div>
                ...
                <DialogFooter>
                    ...
                    <Button type="submit" form="employee-create-form" disabled={processing}>Save Employee</Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
    );
