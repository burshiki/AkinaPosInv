...
import { Upload, FileSpreadsheet, Download, X, CheckCircle, AlertCircle, RefreshCw } from 'lucide-react';
                ...
                <div className="space-y-4">
                    ...
                    <div className="rounded-md border bg-muted/40 px-4 py-3 text-sm space-y-1.5">
                        ...
                        <p className="text-muted-foreground text-xs leading-relaxed">
                            ...
                            <code>sku</code>, <code>barcode</code>, <code>description</code>,{' '}
                            <code>category</code>, <code>cost_price</code>,{' '}
                            <code>selling_price</code>, <code>stock_quantity</code>,{' '}
                            <code>low_stock_threshold</code>, <code>is_active</code>
                        </p>
                        <p className="text-xs text-muted-foreground">
                            If a product with the same <code>sku</code> already exists it will be <strong>updated</strong>; otherwise a new product is created.
                        </p>
                        <a
