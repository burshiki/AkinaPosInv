...
export default function ProductsEdit({ product, categories }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        tax_rate: String(product.tax_rate ?? 12),
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    <Input id="tax_rate" type="number" step="0.01" min="0" max="100" value={data.tax_rate} onChange={(e) => setData('tax_rate', e.target.value)} />
                                    {errors.tax_rate && <p className="text-sm text-destructive">{errors.tax_rate}</p>}
                                </div>
                                <div className="flex items-end pb-2">
                                    <div className="flex items-center space-x-2">
                                        <Checkbox id="is_vat_exempt" checked={data.is_vat_exempt} onCheckedChange={(checked) => setData('is_vat_exempt', !!checked)} />
                            ...
                            <div className="flex items-center space-x-4">
                                <div className="flex items-center space-x-2">
                                    <Checkbox id="is_assembled" checked={data.is_assembled} onCheckedChange={(checked) => setData('is_assembled', !!checked)} />
